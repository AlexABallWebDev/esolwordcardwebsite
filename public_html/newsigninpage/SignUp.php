					...
					<section id="main">
						...
						<form method="post">
							...
							<div class="field">
								...
								<input type="radio" id="robot_yes" name="robot" value="yes" /><label for="robot_yes">Yes</label>
								<input type="radio" id="robot_no" name="robot" value="no" /><label for="robot_no">No</label>
							</div>
							<?php
							if (!$isValid)
							{
						...
						<hr />
						<a href="Log.html" class="button">Go Back</a>
