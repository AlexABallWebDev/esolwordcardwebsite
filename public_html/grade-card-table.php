...
<html>
  ...
  <body>
          ...
          <div class="well">
            <h1>
              Student Cards Overview
						...
						<button id="delete-all-cards" class="alert alert-danger">Delete all cards</button>
	...
	//		table.column(2).search(12).draw();
	//   });
        <?php 
        //sets initail search
        //if (isset($_GET['chapter']))
		//{
			//echo "table.column(2).search(" . $_GET['chapter'] . ").draw();";
		//}
		?> 
		//);
        $('[data-toggle=tooltip]').tooltip();
			...
			//show popup confirmation box when delete all cards button is clicked.
